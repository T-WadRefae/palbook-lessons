...
- **No cross-lesson progress strip** (teacher's rule, 2026-09): do NOT put a unit-wide tracker between the header and the tabs (the "Language Orbit" / "Wild Trail" style strip that lights up a slot per finished period). The per-lesson quiz badge stays; the unit-wide strip was removed from Grade 7 units 2 and 3 and must not come back.
